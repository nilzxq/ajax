...
<title>shoppingCart</title>
 <!-- 
 1.获取当前页面的所有的a节点，并为每一个a节点添加onclick响应函数同时取消其默认行为
 2.准备发送Ajax 请求：url(a节点的href属性值);args(时间戳)
...
<div id="cartstatus">
  ...
  总价格&nbsp;<span id="totalMoney"></span>&nbsp;钱。</div>
   <br><br>
  ...
  <br><br>
    Struts2&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/addToCart?id=Struts2&price=200">加入购物车</a>
  <br><br>
</body>
</html>